...
window.onload = function () {
    ...
    $(function () {
      ...
      function sliderInit(slider, arrows) {
        ...
        slider.on(
          ...
          function (event, slick, currentSlide, nextSlide) {
            const slideCount = Number(nextSlide) + 1;
            document.getElementById(
              "achievements-college__background"
            ).className =
              "college-achievement-slide" + slideCount + "-pattern-animation";
          }
        );
      }
      ...
      setTimeout(function () {
        ...
        $(".js-slider-list").each(function () {
          var $this = $(this),
            $arrows = $this.closest(".js-slider").find(".js-slider-arrows");
        ...
        $(".js-slider-list")
          .on("beforeChange", function (event, slick, currentSlide, nextSlide) {
            $(this)
              .find(".js-slider-item")
              .removeClass("active-1 active-2 active-3 active-4 active-5");
            $(this)
              .find(".js-slider-item[data-item=" + nextSlide + "]")
              .addClass("active-1")
              .removeClass("active-2 active-3 active-4 active-5");
            var slickSlideNext1 = $(this)
              .find(".js-slider-item[data-item=" + nextSlide + "]")
              .closest(".slick-slide")
              .next(".slick-slide")
              .find(".js-slider-item")
              .attr("data-item");
            var slickSlideNext2 = $(this)
              .find(".js-slider-item[data-item=" + nextSlide + "]")
              .closest(".slick-slide")
              .next(".slick-slide")
              .next(".slick-slide")
            ...
            var slickSlideNext4 = $(this)
              ...
              .attr("data-item");
            $(this)
              .find(".js-slider-item[data-item=" + slickSlideNext2 + "]")
              .addClass("active-3");
            $(this)
              .find(".js-slider-item[data-item=" + slickSlideNext1 + "]")
              .addClass("active-2");
            $(this)
              .find(".js-slider-item[data-item=" + slickSlideNext3 + "]")
              .addClass("active-4");
            $(this)
              .find(".js-slider-item[data-item=" + slickSlideNext4 + "]")
              .addClass("active-5");
          })
          .on("init", function () {
            if ($(".courses .responses__item").length < 4) {
              $(".courses .slick-track").css("float", "right");
            }
          });
      }, 2000);
    });
  ...
  if ($(".js-slider2").length) {
    $(function () {
      $(".js-slider2 .js-slider-item").each(function () {
        $(this).attr("data-item", $(this).index());
      });

      $(".js-slider2 .js-slider-item[data-item=0]").addClass("active-1");
      $(".js-slider2 .js-slider-item[data-item=1]").addClass("active-2");
      $(".js-slider2 .js-slider-item[data-item=2]").addClass("active-3");
      $(".js-slider2 .js-slider-item[data-item=3]").addClass("active-4");
      $(".js-slider2 .js-slider-item[data-item=4]").addClass("active-5");

      function sliderInit2(slider, arrows) {
        slider.slick({
          dots: true,
          arrows: true,
          infinite: true,
      ...
      function newsInit2(slider, arrows) {
        slider.slick({
          dots: false,
          arrows: true,
          infinite: true,
      ...
      setTimeout(function () {
        $(".js-slider2 .js-slider-list").on("init", function () {
          $(".js-slider2 .js-slider-loader").removeClass("loaded");
        });

        $(".js-slider2 .js-slider-list").each(function () {
          var $this = $(this),
            $arrows = $this
              .closest(".js-slider2 .js-slider")
              .find(".js-slider2 .js-slider-arrows");
          if ($(this).hasClass("js-slider-news")) {
            newsInit2($this, $arrows);
          } else {
            sliderInit2($this, $arrows);
          }
        });

        $(".js-slider2 .js-slider-list").on(
          "beforeChange",
          function (event, slick, currentSlide, nextSlide) {
            $(this)
              .find(".js-slider2 .js-slider-item")
              .removeClass("active-1 active-2 active-3 active-4 active-5");
            $(this)
              .find(".js-slider2 .js-slider-item[data-item=" + nextSlide + "]")
              .addClass("active-1")
              .removeClass("active-2 active-3 active-4 active-5");
            var slickSlideNext1 = $(this)
              .find(".js-slider2 .js-slider-item[data-item=" + nextSlide + "]")
            ...
            $(this)
              .find(
                ".js-slider2 .js-slider-item[data-item=" + slickSlideNext2 + "]"
              )
              .addClass("active-3");
            $(this)
              .find(
                ".js-slider2 .js-slider-item[data-item=" + slickSlideNext1 + "]"
              )
              .addClass("active-2");
            $(this)
              .find(
                ".js-slider2 .js-slider-item[data-item=" + slickSlideNext3 + "]"
              )
              .addClass("active-4");
            $(this)
              .find(
                ".js-slider2 .js-slider-item[data-item=" + slickSlideNext4 + "]"
              )
              .addClass("active-5");
          }
        );
  ...
  if ($(".js-datepicker").length) {
    function fixDatepicker() {
      $(".js-datepicker").each(function () {
        ...
        $(this)
          .find("tr:first-child td[data-handler]:last-child")
          .addClass("radius-top-right");
        if (!$(this).find("td:first-child").hasClass("radius-top-left")) {
          $(this)
            .find("tr:nth-child(2) td:first-child")
            .addClass("radius-top-left");
        }
        $(this).find("td[data-handler]:last").addClass("radius-bottom-right");
        if (
          !$(this)
            .find("tr:last-child td:last-child")
            .hasClass("radius-bottom-right")
        ) {
          $(this)
            .find("tr:nth-last-child(2) td:last-child")
            .addClass("radius-bottom-right");
        }
      });
    }
